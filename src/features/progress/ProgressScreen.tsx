  ...
  return (
    <div className="flex flex-col space-y-6 animate-fade-in select-none">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#0F172A] tracking-tight">Progress</h1>
      ...
      {/* 2. Overview Metric Cards Grid: 2-col mobile, 4-col desktop */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white/80 border border-[#CBD5E1] rounded-2xl p-4 shadow-sm backdrop-blur-md">
          ...
          <span className="text-xl sm:text-2xl font-bold font-mono-metric text-[#0F172A] mt-1 block">
        ...
        <div className="bg-white/80 border border-[#CBD5E1] rounded-2xl p-4 shadow-sm backdrop-blur-md">
          <div className="flex items-center gap-2 text-[#475569] text-xs font-bold uppercase">
            <TrendingUp size={14} className="text-[#008B8E]" />
            <span>This Week</span>
          </div>
          <span className="text-xl sm:text-2xl font-bold font-mono-metric text-[#0F172A] mt-1 block">
            {stats.thisWeekCount}
        ...
        <div className="bg-white/80 border border-[#CBD5E1] rounded-2xl p-4 shadow-sm backdrop-blur-md">
          <div className="flex items-center gap-2 text-[#475569] text-xs font-bold uppercase">
            <Award size={14} className="text-[#D96B27]" />
            <span>PRs Set</span>
          </div>
          <span className="text-xl sm:text-2xl font-bold font-mono-metric text-[#0F172A] mt-1 block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Left Column: Weekly Consistency & Strength Chart */}
        <div className="lg:col-span-7 space-y-6">
          ...
          {/* Interactive Strength Progression Chart */}
        ...
        {/* Right Column: Personal Records (PRs) List */}
            ...
            {personalRecords.map((pr) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#D96B27]/10 text-[#D96B27] flex items-center justify-center shadow-sm border border-[#D96B27]/30 shrink-0">
